        ...
        <div id='charts' className="bg-gradient-to-b from-[#071019] to-[#0b1418] text-white p-10">
            <header className="max-w-6xl mx-auto mb-4">
                <div className="flex items-center justify-between">
                    <div>
                        <p className='text-white sm:text-28 text-18 mb-3'><span className='text-primary'>SavvyFarm</span> Statistics & Charts</p>
                        <p className='text-muted/60 text-18 mb-7'>
                            Explore SavvyFarm multichain performance at a glance.
                        </p>
                    </div>
                </div>
            </header>
