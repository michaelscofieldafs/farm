...
export const perksData: {
  ...
  space: string;
}[] = [
    {
      ...
      text: "Optimized APRs, emission halving, and token incentives designed for long-term growth.",
      space: "lg:mt-8",
    },
    {
      icon: "/images/perks/icon-community.svg",
      title: "Security & Transparency",
      text: "User trust is a top priority. That’s why our smart contracts are fully verified, our platform data is transparently displayed.",
      space: "lg:mt-14",
    },
    {
