import{dH as y,d$ as ee,cU as l,cW as ae,cD as $,cE as L,cH as w,cI as V,cJ as C,cG as S,da as ne,d3 as D,dn as d,cP as N,cQ as p,cF as se,cL as _,c$ as f,dk as j,dW as le,dO as F,cY as U,dE as R,dm as W,d7 as K,cO as ce,cV as O,e0 as z,dT as G,dl as de,cN as te,e1 as he,dC as c}from"./index-CcpU8MoF.js";import"./index-D6MiywXB.js";import{S as ue}from"./SwapController-B6Wm3pTR.js";const ie={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){y.shake();return}if(await ee.isSIWXCloseDisabled()){y.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&ae.disconnect(),y.close()}},pe=$`
  :host {
    display: block;
